...
public class UserRoleServiceImpl implements UserRoleService {
    ...
    @Autowired
    private WholeUserInfoRepository wholeUserInfoRepository;
    ...
    public PageInfo<UserInfoVO> pageQueryUserInfo(UserPageQueryParam pageParam) {
        ...
        if(null != tokenAndResourceVo && null != tokenAndResourceVo.getUserAndResourceVO() && null != tokenAndResourceVo.getUserAndResourceVO().getUserInfo()){
            ...
            List<UserInfoVO> list = wholeUserInfoRepository.queryNormalUserInfoByUserNameFuzzy(pageParam.getUserName(),userInfoVO.getUserAttribute(),userInfoVO.getLoginName());
    ...
    public String saveUserRole(String uiUuid, List<String> ownerRoleList) {
        ...
        if(lines > 0){
            upUserResourceCacheService.upUserResCacheByRiuuidOrUiuuid(null,uiUuid);
            return "success";
        }
        return "fail";
    }
