...
public class RedisConfig {
    ...
    public KeyGenerator wiselyKeyGenerator() {
        String[] classNameMethod = {"com.vapor.service.impl.AuthorityServiceImpl.queryUserAllResource","com.vapor.service.impl.AuthorityServiceImpl.updateCacheQueryUserAllResource"};
